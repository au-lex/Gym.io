...
const ShoulderDetails = () => {
  const { data, isLoading, error } = ExerciseData("/bodyPart/upper arms?limit=40&offset=0");
  const { id } = useParams();
  ...
  return (
    <>
      ...
      <div className="max-w-xl mx-auto bg-white pt-[6rem] p-4 rounded-lg shadow-lg">
        ...
        <Link to="/upper-arms-exercises" className=' bg-yellow-5 shadow border border-yellow-500 w-[2rem] h-[2rem] 
