...
import ExerciseCard from '../ExerciseCards/ExerCard7';
...
const Waist = () => {
  ...
  const { data, isLoading, error } = ExerciseData(`/bodyPart/upper arms?limit=${pageSize}&offset=${(currentPage - 1) * pageSize}`);
