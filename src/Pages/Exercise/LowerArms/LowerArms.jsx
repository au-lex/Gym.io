...
import ExerciseCard from '../ExerciseCards/ExerCard3';
...
const LowerArms = () => {
  ...
  const { data, isLoading, error } = ExerciseData(`/bodyPart/lower arms?limit=${pageSize}&offset=${(currentPage - 1) * pageSize}`);
  ...
  return (
    <>
      ...
      <Link to="/exercise" className="flex items-center tex-white hover:text-gray-300">
