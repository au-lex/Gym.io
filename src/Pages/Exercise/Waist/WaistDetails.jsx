...
const WaistDetails = () => {
  const { data, isLoading, error } = ExerciseData("/bodyPart/waist?limit=40&offset=0");
  const { id } = useParams();
  ...
  return (
    <>
      ...
      <div className="max-w-xl mx-auto bg-white pt-[6rem] p-4 rounded-lg shadow-lg">
        ...
        <Link to="/waist-exercises" className=' bg-yellow-5 shadow border border-yellow-500 w-[2rem] h-[2rem] 
